...
class OpenbayesPluginConan(ConanFile):
    name = "openbayes_plugin"
    version = "0.5.0"
    license = "MIT"

    url = "https://github.com/grimoire/openbayes_plugin.git"
    repo_url = "https://github.com/grimoire/openbayes_plugin.git"
    description = "openbayes plugin contain some useful tensorrt plugin."
    ...
    def package(self):
        ...
        self.copy(
            "*.h", dst="include/openbayes_cuda_util", src="include/openbayes_cuda_util")
    ...
    def package_info(self):
        self.cpp_info.libs = ["openbayes_plugin"]
