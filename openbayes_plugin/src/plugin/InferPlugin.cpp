...
#include "plugin/openbayesInferPlugin.h"
#include "CenteredLayerPlugin/CenteredLayerPlugin.h"
...
namespace openbayes {
namespace plugin {
REGISTER_TENSORRT_PLUGIN(CenteredLayerPluginCreator);
...
bool initLibOpenbayesInferPlugins() { return true; }
}  // extern "C"
