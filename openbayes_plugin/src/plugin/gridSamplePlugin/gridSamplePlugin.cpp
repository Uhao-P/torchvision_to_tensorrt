...
int GridSamplePluginDynamic::enqueue(
  ...
  openbayes::plugin::GridSamplerInterpolation intep_mode =
      openbayes::plugin::GridSamplerInterpolation::Nearest;
  switch (nvinfer1::ResizeMode(mMode)) {
    case nvinfer1::ResizeMode::kLINEAR:
      intep_mode = openbayes::plugin::GridSamplerInterpolation::Bilinear;
      break;

    case nvinfer1::ResizeMode::kNEAREST:
      intep_mode = openbayes::plugin::GridSamplerInterpolation::Nearest;
      break;
    default:
      break;
  }

  openbayes::plugin::GridSamplerPadding padding_mode =
      openbayes::plugin::GridSamplerPadding::Zeros;
  switch (mPaddingMode) {
    case 0:
      padding_mode = openbayes::plugin::GridSamplerPadding::Zeros;
      break;

    case 1:
      padding_mode = openbayes::plugin::GridSamplerPadding::Border;
      break;

    case 2:
      padding_mode = openbayes::plugin::GridSamplerPadding::Reflection;
      break;
    default:
      break;
  }
