...
class TorchEmbeddingPluginDynamic : public PluginDynamicBase {
 public:
  ...
  // It doesn't make sense to make TorchEmbeddingPluginDynamic without
  // arguments, so we delete default constructor.
  TorchEmbeddingPluginDynamic() = delete;
...
class TorchEmbeddingPluginDynamicCreator : public PluginCreatorBase {
 public:
  TorchEmbeddingPluginDynamicCreator();
