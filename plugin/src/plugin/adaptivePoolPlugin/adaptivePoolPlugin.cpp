...
int AdaptivePoolPluginDynamic::enqueue(
  ...
  openbayes::plugin::PoolType pool_type;
  switch (mPoolingType) {
    case int(nvinfer1::PoolingType::kMAX):
      pool_type = openbayes::plugin::PoolType::MAX;
      break;
    case int(nvinfer1::PoolingType::kAVERAGE):
      pool_type = openbayes::plugin::PoolType::AVERAGE;
      break;
    default:
      break;
  }

  openbayes::plugin::adaptive_pool<float>((float *)outputs[0],
