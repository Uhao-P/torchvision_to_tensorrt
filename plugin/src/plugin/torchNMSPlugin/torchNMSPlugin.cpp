...
size_t TorchNMSPluginDynamic::getWorkspaceSize(
  ...
  size_t index_workspace =
      openbayes::common::getAlignedSize(num_bbox * sizeof(int));
  switch (data_type) {
  ...
  tmp_score_workspace = openbayes::common::getAlignedSize(tmp_score_workspace);
  final_score_workspace =
      openbayes::common::getAlignedSize(final_score_workspace);
  nms_workspace = openbayes::common::getAlignedSize(nms_workspace);
